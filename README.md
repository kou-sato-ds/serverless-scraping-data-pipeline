...
技術選定の根拠と TCO 視点を重視したデータエンジニアリングの作例です。設計判断は全て ADR として記録しています。フィードバック歓迎です。